// =====================================================
// ENHANCED SMART GRIEVANCE SYSTEM - STATIC DEMO ONLY
// Client-side prototype. No backend, localStorage only. Not for production.
// Full app requires Flask backend: see README
// =====================================================

(function injectPrototypeBanner() {
    if (document.readyState === 'loading') {
        document.addEventListener('DOMContentLoaded', injectPrototypeBanner);
        return;
    }
